...
const translations = {
  zh: {
    ...
    'analysis.ttdTrends': 'TTD变化趋势',
    'analysis.ttdTrendsDesc': '每回合决策时间变化 (先降后升为佳)',
    'analysis.last5Matches': '最近5场',
    'analysis.showDistribution': '显示分布图',
    'analysis.showTrends': '显示趋势图',
  ...
  en: {
    ...
    'analysis.ttdTrends': 'TTD Trends',
    'analysis.ttdTrendsDesc': 'Decision time per round (U-curve is optimal)',
    'analysis.last5Matches': 'Last 5 matches',
    'analysis.showDistribution': 'Show distribution',
    'analysis.showTrends': 'Show trends',
